...
object RegressaoLinearObitos {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val obt2013 = sparks.read.option("header", "true")
      ...
      .option("delimiter", ";")
      .csv("file:///Users/nilosaj/Desenvolvimento/projetos/datasets/posgrad_ml/Obitos/Obitos-2013.csv")
    ...
    val obt2012 = sparks.read.option("header", "true")
      .option("inferSchema", "true")
      .option("delimiter", ";")
      .csv("file:///Users/nilosaj/Desenvolvimento/projetos/datasets/posgrad_ml/Obitos/Obitos-2012.csv")
    ...
    val obt2011 = sparks.read.option("header", "true")
      .option("inferSchema", "true")
      .option("delimiter", ";")
      .csv("file:///Users/nilosaj/Desenvolvimento/projetos/datasets/posgrad_ml/Obitos/Obitos-2011.csv")
    ...
    val obt2010 = sparks.read.option("header", "true")
      .option("inferSchema", "true")
      .option("delimiter", ";")
      .csv("file:///Users/nilosaj/Desenvolvimento/projetos/datasets/posgrad_ml/Obitos/Obitos-2010.csv")
    ...
    val leitos2013 = sparks.read.option("header", "true")
      ...
      .csv("file:///Users/nilosaj/Desenvolvimento/projetos/datasets/posgrad_ml/leitos/Leitos-2013.csv")
    ...
    val leitos2012 = sparks.read.option("header", "true")
      .option("inferSchema", "true")
      .option("delimiter", ";")
      .csv("file:///Users/nilosaj/Desenvolvimento/projetos/datasets/posgrad_ml/leitos/Leitos-2012.csv")
      .withColumn("NSUS", when($"NSUS".isNull, 0).otherwise($"NSUS"))
      .withColumn("ano",lit("2012"))
      .select(lower($"municipios").as("municipios"), $"qexistente", $"SUS", $"NSUS",$"ano")
    ...
    val leitos2011 = sparks.read.option("header", "true")
      .option("inferSchema", "true")
      .option("delimiter", ";")
      .csv("file:///Users/nilosaj/Desenvolvimento/projetos/datasets/posgrad_ml/leitos/Leitos-2011.csv")
      .withColumn("NSUS", when($"NSUS".isNull, 0).otherwise($"NSUS"))
      .withColumn("ano",lit("2011"))
      .select(lower($"municipios").as("municipios"), $"qexistente", $"SUS", $"NSUS",$"ano")
    ...
    val leitos2010 = sparks.read.option("header", "true")
      .option("inferSchema", "true")
      .option("delimiter", ";")
      .csv("file:///Users/nilosaj/Desenvolvimento/projetos/datasets/posgrad_ml/leitos/Leitos-2010.csv")
      .withColumn("NSUS", when($"NSUS".isNull, 0).otherwise($"NSUS"))
      .withColumn("ano",lit("2010"))
      .select(lower($"municipios").as("municipios"), $"qexistente", $"SUS", $"NSUS",$"ano")
    ...
    val pibc2012 = sparks.read.option("header","true")
      .option("inferSchema","true")
      .option("delimiter",";")
      .csv("file:///Users/nilosaj/Desenvolvimento/projetos/datasets/posgrad_ml/pibcapta/PIB_CAPTA_2012.csv")
      .withColumn("ano",lit("2012"))
      .select(lower($"municipios").as("municipios"), $"pibcapta",$"ano")
    ...
    val pibc2011 = sparks.read.option("header","true")
      .option("inferSchema","true")
      .option("delimiter",";")
      .csv("file:///Users/nilosaj/Desenvolvimento/projetos/datasets/posgrad_ml/pibcapta/PIB_CAPTA_2011.csv")
      .withColumn("ano",lit("2011"))
      .select(lower($"municipios").as("municipios"), $"pibcapta",$"ano")
    ...
    val pibc2010 = sparks.read.option("header","true")
      .option("inferSchema","true")
      .option("delimiter",";")
      .csv("file:///Users/nilosaj/Desenvolvimento/projetos/datasets/posgrad_ml/pibcapta/PIB_CAPTA_2010.csv")
      .withColumn("ano",lit("2010"))
      .select(lower($"municipios").as("municipios"), $"pibcapta",$"ano")
    ...
    val evitaveis2013 = sparks.read.option("header","true")
      .option("inferSchema","true")
      .option("delimiter",";")
      .csv("file:///Users/nilosaj/Desenvolvimento/projetos/datasets/posgrad_ml/evitaveis/EVITAVEIS-2013.csv")
      .withColumn("ano",lit("2013"))
    ...
    val evitaveis2012 = sparks.read.option("header","true")
      .option("inferSchema","true")
      .option("delimiter",";")
      .csv("file:///Users/nilosaj/Desenvolvimento/projetos/datasets/posgrad_ml/evitaveis/EVITAVEIS-2012.csv")
      .withColumn("ano",lit("2012"))
      .withColumn("rd_imunoprev", when($"rd_imunoprev".isNull, 0).otherwise($"rd_imunoprev"))
      .withColumn("rd_infectoprev", when($"rd_infectoprev".isNull, 0).otherwise($"rd_infectoprev"))
      .withColumn("rd_naotransmissprev", when($"rd_naotransmissprev".isNull, 0).otherwise($"rd_naotransmissprev"))
    ...
    val evitaveis2011 = sparks.read.option("header","true")
      .option("inferSchema","true")
      .option("delimiter",";")
      .csv("file:///Users/nilosaj/Desenvolvimento/projetos/datasets/posgrad_ml/evitaveis/EVITAVEIS-2011.csv")
      .withColumn("ano",lit("2011"))
      .withColumn("rd_imunoprev", when($"rd_imunoprev".isNull, 0).otherwise($"rd_imunoprev"))
      .withColumn("rd_infectoprev", when($"rd_infectoprev".isNull, 0).otherwise($"rd_infectoprev"))
      .withColumn("rd_naotransmissprev", when($"rd_naotransmissprev".isNull, 0).otherwise($"rd_naotransmissprev"))
    ...
    val evitaveis2010 = sparks.read.option("header","true")
      .option("inferSchema","true")
      .option("delimiter",";")
      .csv("file:///Users/nilosaj/Desenvolvimento/projetos/datasets/posgrad_ml/evitaveis/EVITAVEIS-2010.csv")
      .withColumn("ano",lit("2010"))
      .withColumn("rd_imunoprev", when($"rd_imunoprev".isNull, 0).otherwise($"rd_imunoprev"))
      .withColumn("rd_infectoprev", when($"rd_infectoprev".isNull, 0).otherwise($"rd_infectoprev"))
      .withColumn("rd_naotransmissprev", when($"rd_naotransmissprev".isNull, 0).otherwise($"rd_naotransmissprev"))
    ...
    val equipamentos2013 = sparks.read.option("header","true")
      .option("inferSchema","true")
      .option("delimiter",";")
      .csv("file:///Users/nilosaj/Desenvolvimento/projetos/datasets/posgrad_ml/equipamentos/EQUIPAMENTOS-2013.csv")
      .withColumn("ano",lit("2013"))
    ...
    val equipamentos2012 = sparks.read.option("header","true")
      .option("inferSchema","true")
      .option("delimiter",";")
      .csv("file:///Users/nilosaj/Desenvolvimento/projetos/datasets/posgrad_ml/equipamentos/EQUIPAMENTOS-2012.csv")
      .withColumn("ano",lit("2012"))
      .withColumn("audiologia", when($"audiologia".isNull, 0).otherwise($"audiologia"))
      .withColumn("diagnistico_img", when($"diagnistico_img".isNull, 0).otherwise($"diagnistico_img"))
      .withColumn("infra_estrutura", when($"infra_estrutura".isNull, 0).otherwise($"infra_estrutura"))
    ...
    val equipamentos2011 = sparks.read.option("header","true")
      .option("inferSchema","true")
      .option("delimiter",";")
      .csv("file:///Users/nilosaj/Desenvolvimento/projetos/datasets/posgrad_ml/equipamentos/EQUIPAMENTOS-2011.csv")
      .withColumn("ano",lit("2011"))
      .withColumn("audiologia", when($"audiologia".isNull, 0).otherwise($"audiologia"))
      .withColumn("diagnistico_img", when($"diagnistico_img".isNull, 0).otherwise($"diagnistico_img"))
      .withColumn("infra_estrutura", when($"infra_estrutura".isNull, 0).otherwise($"infra_estrutura"))
    ...
    val equipamentos2010 = sparks.read.option("header","true")
      .option("inferSchema","true")
      .option("delimiter",";")
      .csv("file:///Users/nilosaj/Desenvolvimento/projetos/datasets/posgrad_ml/equipamentos/EQUIPAMENTOS-2010.csv")
      .withColumn("ano",lit("2010"))
    ...
    val popul2013 = sparks.read.option("header", "true")
      .option("inferSchema", "true")
      .option("delimiter", ";")
      .csv("file:///Users/nilosaj/Desenvolvimento/projetos/datasets/posgrad_ml/populacao/POPULACAO_EST-2013.csv")
      .withColumn("ano",lit("2013"))
    ...
    val popul2012 = sparks.read.option("header", "true")
      .option("inferSchema", "true")
      .option("delimiter", ";")
      .csv("file:///Users/nilosaj/Desenvolvimento/projetos/datasets/posgrad_ml/populacao/POPULACAO_EST-2012.csv")
      .withColumn("ano",lit("2012"))
      .select(lower($"municipios").as("municipios"), $"populacao",$"ano")
    ...
    val popul2011 = sparks.read.option("header", "true")
      .option("inferSchema", "true")
      .option("delimiter", ";")
      .csv("file:///Users/nilosaj/Desenvolvimento/projetos/datasets/posgrad_ml/populacao/POPULACAO_EST-2011.csv")
      .withColumn("ano",lit("2011"))
      .select(lower($"municipios").as("municipios"), $"populacao",$"ano")
    ...
    val popul2010 = sparks.read.option("header", "true")
      .option("inferSchema", "true")
      .option("delimiter", ";")
      .csv("file:///Users/nilosaj/Desenvolvimento/projetos/datasets/posgrad_ml/populacao/POPULACAO_EST-2010.csv")
      .withColumn("ano",lit("2010"))
      .select(lower($"municipios").as("municipios"), $"populacao",$"ano")
