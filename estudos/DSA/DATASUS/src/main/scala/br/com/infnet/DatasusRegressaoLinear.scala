...
object DatasusRegressaoLinear {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val filePath = "hdfs://hdpmasternode:19000/datasets"
    ...
    val lr = new LinearRegression().setMaxIter(1).setRegParam(0.3).setElasticNetParam(0.8)
